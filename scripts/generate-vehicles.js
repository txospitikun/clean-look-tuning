...
function model(name, years, image, enginesPick) {
  return { name, slug: slug(name), years, image, engines: enginesPick };
}
...
const brands = [
  ...
  brand("Volkswagen", "volkswagen.svg", [
    model("Golf VII", "2012-2019", null, pick(VAG_ENGINES)),
    model("Golf VIII", "2019-2024", null, pick(VAG_ENGINES, { dieselFilter: (e) => e.hp >= 110, petrolFilter: (e) => e.hp >= 110 })),
    model("Golf VI", "2008-2012", null, pick(VAG_ENGINES, { dieselFilter: (e) => e.hp <= 170, petrolFilter: (e) => e.hp <= 200 })),
    model("Passat B8", "2014-2023", null, pick(VAG_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Passat B7", "2010-2014", null, pick(VAG_ENGINES, { dieselFilter: medDiesel, petrolFilter: (e) => e.hp >= 100 && e.hp <= 210 })),
    model("Tiguan", "2016-2024", null, pick(VAG_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Tiguan I", "2007-2016", null, pick(VAG_ENGINES, { dieselFilter: medDiesel, petrolFilter: (e) => e.hp >= 100 && e.hp <= 210 })),
    model("Polo AW", "2017-2024", null, pick(VAG_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("Polo 6R/6C", "2009-2017", null, pick(VAG_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("T-Roc", "2017-2024", null, pick(VAG_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Touran", "2015-2024", null, pick(VAG_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Arteon", "2017-2024", null, pick(VAG_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
    model("Caddy", "2015-2024", null, pick(VAG_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("Transporter T6", "2015-2024", null, pick(VAG_ENGINES, { diesel: true, petrol: false, dieselFilter: medDiesel })),
  ]),

  brand("Audi", "audi.svg", [
    model("A3 8V", "2012-2020", null, pick(VAG_ENGINES)),
    model("A3 8Y", "2020-2024", null, pick(VAG_ENGINES, { dieselFilter: (e) => e.hp >= 110, petrolFilter: (e) => e.hp >= 110 })),
    model("A4 B8", "2007-2015", null, pick(VAG_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("A4 B9", "2015-2024", null, pick(VAG_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("A5 F5", "2016-2024", null, pick(VAG_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("A6 C7", "2011-2018", null, pick(VAG_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
    model("A6 C8", "2018-2024", null, pick(VAG_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
    model("Q3", "2011-2018", null, pick(VAG_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Q3 F3", "2018-2024", null, pick(VAG_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Q5 FY", "2016-2024", null, pick(VAG_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
    model("Q7", "2015-2024", null, pick(VAG_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
    model("TT 8S", "2014-2023", null, pick(VAG_ENGINES, { diesel: false, petrolFilter: bigPetrol })),
  ]),

  brand("Skoda", "skoda.svg", [
    model("Octavia III", "2012-2020", null, pick(VAG_ENGINES)),
    model("Octavia IV", "2020-2024", null, pick(VAG_ENGINES, { dieselFilter: (e) => e.hp >= 110, petrolFilter: (e) => e.hp >= 110 })),
    model("Superb III", "2015-2024", null, pick(VAG_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Fabia III", "2014-2021", null, pick(VAG_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("Fabia IV", "2021-2024", null, pick(VAG_ENGINES, { diesel: false, petrolFilter: smallPetrol })),
    model("Karoq", "2017-2024", null, pick(VAG_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Kodiaq", "2016-2024", null, pick(VAG_ENGINES, { dieselFilter: medDiesel, petrolFilter: bigPetrol })),
    model("Scala", "2018-2024", null, pick(VAG_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("Kamiq", "2019-2024", null, pick(VAG_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
  ]),

  brand("Seat", "seat.svg", [
    model("Leon III", "2012-2020", null, pick(VAG_ENGINES)),
    model("Leon IV", "2020-2024", null, pick(VAG_ENGINES, { dieselFilter: (e) => e.hp >= 110, petrolFilter: (e) => e.hp >= 110 })),
    model("Ateca", "2016-2024", null, pick(VAG_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Tarraco", "2018-2024", null, pick(VAG_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Ibiza V", "2017-2024", null, pick(VAG_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("Arona", "2017-2024", null, pick(VAG_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
  ]),

  brand("Cupra", "cupra.svg", [
    model("Formentor", "2020-2024", null, pick(VAG_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
    model("Leon", "2020-2024", null, pick(VAG_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
    model("Ateca", "2018-2024", null, pick(VAG_ENGINES, { diesel: false, petrolFilter: bigPetrol })),
  ]),

  /* ─── BMW / MINI ─── */
  brand("BMW", "bmw.svg", [
    model("Seria 1 F20/F21", "2011-2019", null, pick(BMW_ENGINES)),
    model("Seria 1 F40", "2019-2024", null, pick(BMW_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Seria 2 F22/F23", "2014-2021", null, pick(BMW_ENGINES)),
    model("Seria 3 F30/F31", "2011-2019", null, pick(BMW_ENGINES)),
    model("Seria 3 G20/G21", "2019-2024", null, pick(BMW_ENGINES)),
    model("Seria 4 F32/F33", "2013-2020", null, pick(BMW_ENGINES, { dieselFilter: medDiesel, petrolFilter: bigPetrol })),
    model("Seria 4 G22/G23", "2020-2024", null, pick(BMW_ENGINES, { dieselFilter: medDiesel, petrolFilter: bigPetrol })),
    model("Seria 5 F10/F11", "2010-2017", null, pick(BMW_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
    model("Seria 5 G30/G31", "2017-2024", null, pick(BMW_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
    model("X1 F48", "2015-2022", null, pick(BMW_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("X1 U11", "2022-2024", null, pick(BMW_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("X3 F25", "2010-2017", null, pick(BMW_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("X3 G01", "2017-2024", null, pick(BMW_ENGINES)),
    model("X5 F15", "2013-2018", null, pick(BMW_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
    model("X5 G05", "2018-2024", null, pick(BMW_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
  ]),

  brand("MINI", "mini.svg", [
    model("Cooper F56", "2014-2024", null, pick(MINI_ENGINES)),
    model("Countryman F60", "2017-2024", null, pick(MINI_ENGINES)),
    model("Clubman F54", "2015-2024", null, pick(MINI_ENGINES)),
  ]),

  /* ─── MERCEDES ─── */
  brand("Mercedes-Benz", "mercedes.svg", [
    model("A-Class W176", "2012-2018", null, pick(MERCEDES_ENGINES)),
    model("A-Class W177", "2018-2024", null, pick(MERCEDES_ENGINES)),
    model("C-Class W205", "2014-2021", null, pick(MERCEDES_ENGINES)),
    model("C-Class W206", "2021-2024", null, pick(MERCEDES_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("E-Class W213", "2016-2023", null, pick(MERCEDES_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
    model("GLA X156", "2013-2019", null, pick(MERCEDES_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("GLA H247", "2019-2024", null, pick(MERCEDES_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("GLB X247", "2019-2024", null, pick(MERCEDES_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("GLC X253", "2015-2022", null, pick(MERCEDES_ENGINES)),
    model("GLC X254", "2022-2024", null, pick(MERCEDES_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
    model("GLE W166", "2015-2019", null, pick(MERCEDES_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
    model("GLE W167", "2019-2024", null, pick(MERCEDES_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
    model("CLA C117", "2013-2019", null, pick(MERCEDES_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("CLA C118", "2019-2024", null, pick(MERCEDES_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
  ]),

  /* ─── FORD ─── */
  brand("Ford", "ford.svg", [
    model("Focus III", "2011-2018", null, pick(FORD_ENGINES)),
    model("Focus IV", "2018-2024", null, pick(FORD_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Fiesta VII", "2017-2023", null, pick(FORD_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("Kuga II", "2012-2019", null, pick(FORD_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Kuga III", "2019-2024", null, pick(FORD_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Mondeo V", "2014-2022", null, pick(FORD_ENGINES, { dieselFilter: medDiesel, petrolFilter: bigPetrol })),
    model("Puma", "2019-2024", null, pick(FORD_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("EcoSport", "2013-2022", null, pick(FORD_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("Transit Custom", "2013-2024", null, pick(FORD_ENGINES, { diesel: true, petrol: false, dieselFilter: medDiesel })),
    model("Ranger", "2015-2024", null, pick(FORD_ENGINES, { diesel: true, petrol: false, dieselFilter: bigDiesel })),
    model("Mustang VI", "2015-2024", null, pick(FORD_ENGINES, { diesel: false, petrolFilter: bigPetrol })),
  ]),

  /* ─── OPEL ─── */
  brand("Opel", "opel.svg", [
    model("Astra K", "2015-2021", null, pick(OPEL_ENGINES)),
    model("Astra L", "2021-2024", null, pick(OPEL_ENGINES, { dieselFilter: (e) => e.hp >= 105, petrolFilter: (e) => e.hp >= 110 })),
    model("Astra J", "2009-2015", null, pick(OPEL_ENGINES)),
    model("Insignia B", "2017-2024", null, pick(OPEL_ENGINES, { dieselFilter: medDiesel, petrolFilter: bigPetrol })),
    model("Insignia A", "2008-2017", null, pick(OPEL_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Corsa F", "2019-2024", null, pick(OPEL_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("Corsa E", "2014-2019", null, pick(OPEL_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("Mokka", "2012-2019", null, pick(OPEL_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Mokka B", "2020-2024", null, pick(OPEL_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Crossland", "2017-2024", null, pick(OPEL_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("Grandland", "2017-2024", null, pick(OPEL_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Zafira C", "2011-2019", null, pick(OPEL_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
  ]),

  /* ─── RENAULT / DACIA ─── */
  brand("Renault", "renault.svg", [
    model("Megane IV", "2016-2023", null, pick(RENAULT_ENGINES)),
    model("Megane III", "2008-2016", null, pick(RENAULT_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Clio V", "2019-2024", null, pick(RENAULT_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("Clio IV", "2012-2019", null, pick(RENAULT_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("Captur II", "2019-2024", null, pick(RENAULT_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("Captur I", "2013-2019", null, pick(RENAULT_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("Kadjar", "2015-2022", null, pick(RENAULT_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Talisman", "2015-2022", null, pick(RENAULT_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Scenic IV", "2016-2022", null, pick(RENAULT_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Koleos II", "2016-2024", null, pick(RENAULT_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
    model("Master III", "2010-2024", null, pick(RENAULT_ENGINES, { diesel: true, petrol: false, dieselFilter: medDiesel })),
    model("Trafic III", "2014-2024", null, pick(RENAULT_ENGINES, { diesel: true, petrol: false, dieselFilter: medDiesel })),
  ]),

  brand("Dacia", "dacia.svg", [
    model("Duster II", "2018-2024", null, pick(RENAULT_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("Duster I", "2010-2018", null, pick(RENAULT_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("Logan III", "2020-2024", null, pick(RENAULT_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("Sandero III", "2020-2024", null, pick(RENAULT_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("Jogger", "2022-2024", null, pick(RENAULT_ENGINES, { diesel: false, petrolFilter: smallPetrol })),
  ]),

  /* ─── PSA ─── */
  brand("Peugeot", "peugeot.svg", [
    model("308 II", "2013-2021", null, pick(PSA_ENGINES)),
    model("308 III", "2021-2024", null, pick(PSA_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("208 II", "2019-2024", null, pick(PSA_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("208 I", "2012-2019", null, pick(PSA_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("3008 II", "2016-2024", null, pick(PSA_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("5008 II", "2017-2024", null, pick(PSA_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("2008 II", "2019-2024", null, pick(PSA_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("508 II", "2018-2024", null, pick(PSA_ENGINES, { dieselFilter: medDiesel, petrolFilter: bigPetrol })),
    model("Rifter", "2018-2024", null, pick(PSA_ENGINES, { dieselFilter: medDiesel, petrolFilter: smallPetrol })),
    model("Partner III", "2018-2024", null, pick(PSA_ENGINES, { diesel: true, petrol: false, dieselFilter: medDiesel })),
  ]),

  brand("Citroen", "citroen.svg", [
    model("C3 III", "2016-2024", null, pick(PSA_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("C3 Aircross", "2017-2024", null, pick(PSA_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("C4 III", "2020-2024", null, pick(PSA_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("C4 Cactus", "2014-2020", null, pick(PSA_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("C5 Aircross", "2018-2024", null, pick(PSA_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Berlingo III", "2018-2024", null, pick(PSA_ENGINES, { dieselFilter: medDiesel, petrolFilter: smallPetrol })),
    model("C-Elysee", "2012-2020", null, pick(PSA_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
  ]),

  /* ─── HYUNDAI / KIA ─── */
  brand("Hyundai", "hyundai.svg", [
    model("Tucson TL", "2015-2020", null, pick(HYUNDAI_KIA_ENGINES)),
    model("Tucson NX4", "2020-2024", null, pick(HYUNDAI_KIA_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("i30 PD", "2017-2024", null, pick(HYUNDAI_KIA_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("i30 N", "2017-2024", null, pick(HYUNDAI_KIA_ENGINES, { diesel: false, petrolFilter: bigPetrol })),
    model("i20 GB", "2020-2024", null, pick(HYUNDAI_KIA_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("i20 N", "2021-2024", null, pick(HYUNDAI_KIA_ENGINES, { diesel: false, petrolFilter: bigPetrol })),
    model("Kona", "2017-2024", null, pick(HYUNDAI_KIA_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Santa Fe TM", "2018-2024", null, pick(HYUNDAI_KIA_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
    model("ix35", "2010-2015", null, pick(HYUNDAI_KIA_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
  ]),

  brand("Kia", "kia.svg", [
    model("Sportage QL", "2015-2021", null, pick(HYUNDAI_KIA_ENGINES)),
    model("Sportage NQ5", "2021-2024", null, pick(HYUNDAI_KIA_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Ceed CD", "2018-2024", null, pick(HYUNDAI_KIA_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Ceed GT", "2019-2024", null, pick(HYUNDAI_KIA_ENGINES, { diesel: false, petrolFilter: bigPetrol })),
    model("Stonic", "2017-2024", null, pick(HYUNDAI_KIA_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("Rio YB", "2017-2024", null, pick(HYUNDAI_KIA_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("Sorento UM", "2014-2020", null, pick(HYUNDAI_KIA_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
    model("XCeed", "2019-2024", null, pick(HYUNDAI_KIA_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Stinger", "2017-2024", null, pick(HYUNDAI_KIA_ENGINES, { diesel: false, petrolFilter: bigPetrol })),
    model("Proceed GT", "2019-2024", null, pick(HYUNDAI_KIA_ENGINES, { diesel: false, petrolFilter: bigPetrol })),
  ]),

  /* ─── FIAT / ALFA ─── */
  brand("Fiat", "fiat.svg", [
    model("Tipo", "2016-2024", null, pick(FIAT_ENGINES)),
    model("500X", "2014-2024", null, pick(FIAT_ENGINES)),
    model("500L", "2012-2022", null, pick(FIAT_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("Punto", "2005-2018", null, pick(FIAT_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("Ducato III", "2006-2024", null, pick(FIAT_ENGINES, { diesel: true, petrol: false })),
    model("Doblo II", "2010-2022", null, pick(FIAT_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
  ]),

  brand("Alfa Romeo", "alfa-romeo.svg", [
    model("Giulietta", "2010-2020", null, pick(ALFA_ROMEO_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Giulia", "2016-2024", null, pick(ALFA_ROMEO_ENGINES)),
    model("Stelvio", "2017-2024", null, pick(ALFA_ROMEO_ENGINES)),
    model("MiTo", "2008-2018", null, pick(ALFA_ROMEO_ENGINES, { dieselFilter: smallDiesel, petrolFilter: (e) => e.hp <= 200 })),
  ]),

  /* ─── VOLVO ─── */
  brand("Volvo", "volvo.svg", [
    model("XC60 II", "2017-2024", null, pick(VOLVO_ENGINES)),
    model("XC60 I", "2008-2017", null, pick(VOLVO_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("XC40", "2017-2024", null, pick(VOLVO_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("XC90 II", "2015-2024", null, pick(VOLVO_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
    model("V40", "2012-2019", null, pick(VOLVO_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("V60 II", "2018-2024", null, pick(VOLVO_ENGINES)),
    model("V90/S90", "2016-2024", null, pick(VOLVO_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
  ]),

  /* ─── TOYOTA ─── */
  brand("Toyota", "toyota.svg", [
    model("Corolla E210", "2018-2024", null, pick(TOYOTA_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Yaris XP210", "2020-2024", null, pick(TOYOTA_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("C-HR", "2016-2024", null, pick(TOYOTA_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("RAV4 V", "2018-2024", null, pick(TOYOTA_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Hilux VIII", "2015-2024", null, pick(TOYOTA_ENGINES, { diesel: true, petrol: false, dieselFilter: bigDiesel })),
    model("Land Cruiser J150", "2009-2024", null, pick(TOYOTA_ENGINES, { diesel: true, petrol: false, dieselFilter: bigDiesel })),
    model("Avensis T27", "2009-2018", null, pick(TOYOTA_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
  ]),

  /* ─── NISSAN ─── */
  brand("Nissan", "nissan.svg", [
    model("Qashqai J11", "2013-2021", null, pick(NISSAN_ENGINES)),
    model("Qashqai J12", "2021-2024", null, pick(NISSAN_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Juke F16", "2019-2024", null, pick(NISSAN_ENGINES, { diesel: false, petrolFilter: smallPetrol })),
    model("Juke F15", "2010-2019", null, pick(NISSAN_ENGINES, { dieselFilter: smallDiesel, petrolFilter: smallPetrol })),
    model("X-Trail T32", "2014-2022", null, pick(NISSAN_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Navara D23", "2015-2024", null, pick(NISSAN_ENGINES, { diesel: true, petrol: false, dieselFilter: bigDiesel })),
  ]),

  /* ─── MAZDA ─── */
  brand("Mazda", "mazda.svg", [
    model("3 BP", "2019-2024", null, pick(MAZDA_ENGINES)),
    model("3 BM/BN", "2013-2019", null, pick(MAZDA_ENGINES)),
    model("6 GL", "2018-2024", null, pick(MAZDA_ENGINES)),
    model("CX-5 KF", "2017-2024", null, pick(MAZDA_ENGINES)),
    model("CX-30", "2019-2024", null, pick(MAZDA_ENGINES)),
    model("MX-5 ND", "2015-2024", null, pick(MAZDA_ENGINES, { diesel: false })),
  ]),

  /* ─── HONDA ─── */
  brand("Honda", "honda.svg", [
    model("Civic X", "2017-2022", null, pick(HONDA_ENGINES)),
    model("Civic XI", "2022-2024", null, pick(HONDA_ENGINES, { diesel: false })),
    model("CR-V V", "2017-2024", null, pick(HONDA_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("HR-V II", "2015-2022", null, pick(HONDA_ENGINES, { dieselFilter: medDiesel, petrolFilter: (e) => e.hp <= 200 })),
    model("Civic Type R FK8", "2017-2021", null, [
  ...
  brand("Suzuki", "suzuki.svg", [
    model("Vitara IV", "2015-2024", null, pick(SUZUKI_ENGINES)),
    model("S-Cross II", "2022-2024", null, pick(SUZUKI_ENGINES)),
    model("Swift VI", "2017-2024", null, pick(SUZUKI_ENGINES, { petrolFilter: smallPetrol })),
    model("Jimny IV", "2018-2024", null, pick(SUZUKI_ENGINES, { diesel: false, petrolFilter: smallPetrol })),
  ]),

  /* ─── MITSUBISHI ─── */
  brand("Mitsubishi", "mitsubishi.svg", [
    model("ASX", "2010-2024", null, pick(MITSUBISHI_ENGINES)),
    model("Outlander III", "2012-2022", null, pick(MITSUBISHI_ENGINES)),
    model("Eclipse Cross", "2018-2024", null, pick(MITSUBISHI_ENGINES)),
    model("L200 V", "2015-2024", null, pick(MITSUBISHI_ENGINES, { diesel: true, petrol: false })),
  ]),

  /* ─── PORSCHE ─── */
  brand("Porsche", "porsche.svg", [
    model("Macan", "2014-2024", null, pick(PORSCHE_ENGINES)),
    model("Cayenne III", "2018-2024", null, pick(PORSCHE_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
    model("Cayenne II", "2010-2018", null, pick(PORSCHE_ENGINES)),
    model("Panamera II", "2016-2024", null, pick(PORSCHE_ENGINES, { diesel: false, petrolFilter: bigPetrol })),
    model("718 Cayman/Boxster", "2016-2024", null, pick(PORSCHE_ENGINES, { diesel: false, petrolFilter: bigPetrol })),
    model("911 991", "2011-2019", null, pick(PORSCHE_ENGINES, { diesel: false, petrolFilter: bigPetrol })),
  ]),

  /* ─── JAGUAR / LAND ROVER ─── */
  brand("Jaguar", "jaguar.svg", [
    model("XE", "2015-2024", null, pick(JAGUAR_ENGINES)),
    model("XF X260", "2015-2024", null, pick(JAGUAR_ENGINES)),
    model("F-Pace", "2016-2024", null, pick(JAGUAR_ENGINES)),
    model("E-Pace", "2017-2024", null, pick(JAGUAR_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("F-Type", "2013-2024", null, pick(JAGUAR_ENGINES, { diesel: false, petrolFilter: bigPetrol })),
  ]),

  brand("Land Rover", "land-rover.svg", [
    model("Range Rover Evoque II", "2019-2024", null, pick(LAND_ROVER_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Range Rover Evoque I", "2011-2019", null, pick(LAND_ROVER_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Range Rover Velar", "2017-2024", null, pick(LAND_ROVER_ENGINES)),
    model("Range Rover Sport II", "2014-2022", null, pick(LAND_ROVER_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
    model("Discovery Sport", "2014-2024", null, pick(LAND_ROVER_ENGINES, { dieselFilter: medDiesel, petrolFilter: medPetrol })),
    model("Discovery V", "2017-2024", null, pick(LAND_ROVER_ENGINES, { dieselFilter: bigDiesel, petrolFilter: bigPetrol })),
    model("Defender", "2019-2024", null, pick(LAND_ROVER_ENGINES)),
  ]),
];
